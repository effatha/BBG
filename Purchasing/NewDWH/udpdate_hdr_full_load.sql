...
FROM  TEST.L0_S4HANA_2LIS_02_HDR hdr
INNER JOIN TEST.L0_S4HANA_2LIS_02_HDR_FULL bck
    on bck.ebeln =hdr.ebeln 
     
WHERE 
    hdr.LOAD_TIMESTAMP = '2025-03-18 10:56:29.000'



    -- insert new ones

INSERT INTO  TEST.L0_S4HANA_2LIS_02_HDR 
(
ROCANCEL
,HDRVORG
,ALIEF
...
FROM  TEST.L0_S4HANA_2LIS_02_HDR_FULL bck
LEFT JOIN TEST.L0_S4HANA_2LIS_02_HDR hdr
    on bck.ebeln =hdr.ebeln 
WHERE 
    hdr.EBELN is null