/****** Object:  StoredProcedure [WR].[WR_TX_L1_FACT_F_BUSINESS_PLAN_L1_FACT_F_BUSINESS_PLAN_STEERING_KPI]    Script Date: 02/12/2024 19:00:47 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER PROC [WR].[WR_TX_L1_FACT_F_BUSINESS_PLAN_L1_FACT_F_BUSINESS_PLAN_STEERING_KPI] @source [nvarchar](50) AS
BEGIN
IF(@source IS NULL)
BEGIN
	SET @source= 'ALL'
