/****** Object:  StoredProcedure [WR].[WR_TX_L0_MI_BUSINESS_PLAN_L1_FACT_F_BUSINESS_PLAN_STEERING]    Script Date: 02/12/2024 18:26:44 ******/
SET ANSI_NULLS ON
GO
...
UPDATE s SET s.VL_REFUND_RATE = NULL from  [L1].[L1_FACT_F_BUSINESS_PLAN_STEERING] s WHERE VL_REFUND_RATE = 0
UPDATE s SET s.VL_RETURN_RATE = NULL from  [L1].[L1_FACT_F_BUSINESS_PLAN_STEERING] s WHERE VL_RETURN_RATE = 0
UPDATE s SET s.VL_REPLACEMENT_RATE = NULL from  [L1].[L1_FACT_F_BUSINESS_PLAN_STEERING] s WHERE VL_REPLACEMENT_RATE = 0
